...
Two middleware functions are provided by default in the `myapp.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `myapp.handler` namespace to manage the enabled middleware.
