...
{{
var G__6453 = cljs.core.pop.call(null,v__$1);
v__$1 = G__6453;
continue;
}
} else
...
{var pred__6457 = cljs.core._EQ_;var expr__6458 = limit;if(cljs.core.truth_(pred__6457.call(null,1,expr__6458)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__6457.call(null,2,expr__6458)))
...
var G__6460 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__6461 = (limit__$1 - 1);
var G__6462 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__6460;
limit__$1 = G__6461;
parts = G__6462;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___6464 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___6464))
{var replacement_6465 = temp__4124__auto___6464;buffer.append([cljs.core.str(replacement_6465)].join(''));
} else
{buffer.append(ch);
}
{
