...
goog.require('domina');
goog.require('domina');
modern_cljs.login.validate_form = (function validate_form(){var username = domina.by_id.call(null,"username");var password = domina.by_id.call(null,"password");if(((cljs.core.count.call(null,domina.value.call(null,username)) > 0)) && ((cljs.core.count.call(null,domina.value.call(null,password)) > 0)))
{return true;
} else
