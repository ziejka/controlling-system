...
{{
var G__5601 = cljs.core.pop.call(null,v__$1);
v__$1 = G__5601;
continue;
}
} else
...
{var pred__5605 = cljs.core._EQ_;var expr__5606 = limit;if(cljs.core.truth_(pred__5605.call(null,1,expr__5606)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__5605.call(null,2,expr__5606)))
...
var G__5608 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__5609 = (limit__$1 - 1);
var G__5610 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5608;
limit__$1 = G__5609;
parts = G__5610;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___5612 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___5612))
{var replacement_5613 = temp__4124__auto___5612;buffer.append([cljs.core.str(replacement_5613)].join(''));
} else
{buffer.append(ch);
}
{
